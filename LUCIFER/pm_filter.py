...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, MSG_ALRT, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, SPELL_IMG, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, SUPPORT_GROUP, SUPPORT_CHAT, HOW_DWLD_LINK, DELETE_TIME, SPL_DELETE_TIME, IS_VERIFY
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, CallbackQuery
from pyrogram import Client, filters, enums
from pyrogram.errors import FloodWait, UserIsBlocked, MessageNotModified, PeerIdInvalid
from utils import get_size, is_subscribed, get_poster, temp, get_settings, save_group_settings, get_shortlink, search_gagala, check_verification, get_token
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('Tᴏɴʏ Sᴛᴀʀᴋ 🪔 Bᴏᴛ Lᴏɢs', url="https://t.me/TonyStark_Logs_Channel")
                     ], [
                      InlineKeyboardButton('Gʀᴏᴜᴘ', url='t.me/CpFlicks_Movies'),
                      InlineKeyboardButton('Cʜᴀɴɴᴇʟ', url='t.me/CpFlicks')
                     ], [
                      InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='t.me/+BNZs3Q3kwmIwMDll'),
                      InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='t.me/CpFlicks')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
